      ...
      <div class="resume">
        <div class="container"> 
          ...
          <div class="row"> 
            ...
            <!-- Sidebar -->
            <div class="col-md-4">
              <?php $this->load->view('common/sidebar',['page'=>'portfolio']); ?>
            </div>
            <!--./side bar-->
            ...
            <div class="col-md-8"> 
            <!-- navbar -->              
            <?php $this->load->view('common/nav',['item'=>'portfolio']); ?>
            <!--./navbar-->  
                  ...
                  <div class="inside-sec"> 
                    ...
                    <section class="about-me padding-top-10"> 
                      ...
                      <ul class="personal-info">
                        <li>
                          <p> <span> Name</span> Kartik Chaudhari </p>
                        </li>
                        <li>
                          <p> <span> Age</span> 23 Years </p>
                        </li>
                        <li>
                          <p> <span> Location</span> Chandkheda, Ahmedabad </p>
                        </li>
                        <li>
                          <p> <span> Experience</span> Fresher </p>
                        </li>
                        <li>
                          <p> <span> Degree</span> B.E </p>
                        </li>
                        <li>
                          <p> <span> Career Level</span> Fresher </p>
                        </li>
                        <li>
                          <p> <span> Phone</span> (91) 8153976277</p>
                        </li>
                        <li>
                          <p> <span style="width: 80px;"> E-mail</span> <a href="mailto:kartikchaudhari456@gmail.com"> kartikchaudhari456@gmail.com</a> </p>
                        </li>
                        <li>
                          <p> <span> Website</span><a href="http://devkartik.ml"> http://devkartik.ml </a></p>
                        </li>
                      </ul>
